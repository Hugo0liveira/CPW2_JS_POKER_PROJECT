    ...
    if(card.suit == "Elysium"){      
      if(num == 1){ 
        ...
        <div class="imgElysium">
          <img src="visual/Elysium.png">
        </div>
        `;    
        card1HTML.style.backgroundImage = `url('visual/Elysium.png')`;    
  ...
  function cssArtificial(card, num){
    if(card.author == 'Artificial'){
      if(num == 1){
        ...
        cardHTML.style.backgroundImage = `url('visual/artificial.png')`;
    ...
    function cardsPlayer1FaceUp() {      
      ...
      setTimeout(function(){        
        ...
        const cardEl = document.querySelector(".card1FaceDown");       
          ...
          cardEl.style.backgroundImage = `url('visual/tombstone.png')`;
        ...
        const cardE2 = document.querySelector(".card2FaceDown");     
          ...
          cardE2.style.backgroundImage = `url('visual/tombstone.png')`;
  ...
  function distributeCards2() {        
    ...
    setTimeout(function(){
        ...
        console.log('card3:',card3); console.log('card4:',card4);
          ...
          cardE3.style.backgroundImage = `url('visual/tombstone.png')`;
          ...
          cardE4.style.backgroundImage = `url('visual/tombstone.png')`;
