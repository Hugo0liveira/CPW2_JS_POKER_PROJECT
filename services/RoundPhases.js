...
function PhasePreFlop(){     
  document.body.style.backgroundImage = "url('visual/Calverton-National-Cemetery.jpg')";
...
function compareTheHands(){      
  ...
  function welcomeDeath() {
    ...
    document.body.style.backgroundImage = "url('visual/deathWelcome.gif')";
  ...
  function deathWinExplosion() {
    ...
    endHTML.innerHTML = "";
    document.body.style.backgroundImage = "url('visual/explosion.gif')";
    document.body.style.backgroundPosition = "center";
  ...
  function deathEndStare() {    
    ...
    document.body.style.backgroundImage = "url('visual/deathEndStare.gif')";
    // centralizing backgorund image
    document.body.style.backgroundPosition = "center";

    setTimeout( function() {
        endHTML.innerHTML = "";
        document.body.style.backgroundImage = "url('visual/eye.png')";    
    }, 1600);
  } 
